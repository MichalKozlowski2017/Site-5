...
class DeclarationBlockTest extends \PHPUnit_Framework_TestCase {
	...
	public function expandBorderShorthandProvider() {
		return array(
			array('body{ border: 2px solid #000 }', 'body {border-width: 2px;border-style: solid;border-color: $color_black;}'),
	...
	public function createBorderShorthandProvider() {
		return array(
			array('body {border-width: 2px;border-style: solid;border-color: $color_black;}', 'body {border: 2px solid $color_black;}'),
